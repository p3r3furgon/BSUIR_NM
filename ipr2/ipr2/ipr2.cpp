...
int main()
{
	...
	do
	{
		...
		x21 = f2(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
		x31 = f3(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
		x41 = f4(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
		x51 = f5(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
		x61 = f6(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
		x71 = f7(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
		x81 = f8(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
		x91 = f9(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
		x101 = f10(x10, x20, x30, x40, x50, x60, x70, x80, x90, x100);
